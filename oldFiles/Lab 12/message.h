...
public:
	...
	string getTextControl() const { return textControl; }
	...
	Control calculateControl(const string control);

	Control getAssetControl() const { return assetControl; }
